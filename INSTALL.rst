========================================================================
** djxoops ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **djxoops** in your system. 
...
To install **djxoops** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/djxoops.git#egg=djxoops

The above command will install the latest development release of **djxoops**.
